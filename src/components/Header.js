        ...
        <div className='d-flex brand-logo'>
          ...
          <div className='col-md-8 col-8 mt-3 search'>
            <div class="input-group mb-3 border border-1 rounded-2">
              <span class="input-group-text bg-transparent border-0 all"><b>All Categori</b></span>
          ...
          <div className='col-md-5  col-12 mt-3 heading-inner' align="end">
            ...
            <a className='addit position-relative'>
              ...
              <span className='icontop text-white bg-success position-absolute top-0 translate-middle'>0</span>
              Compare
            </a>
            <a className='addit position-relative'>
              <i className="fa fa-heart-o hicon ms-1 me-1"></i>
              <span className='icontop text-white bg-success translate-middle position-absolute top-0 translate-middle'>0</span>
              Wishlist
            </a>
            <a className='addit position-relative'>
