...
export default function SlickSlider() {
    ...
    return (
        ...
        <Row>
            ...
            <div className="col-2  buttons" align="end">
                <button className="p-1 border border-0 ps-2 pe-2"><i class="fa fa-arrow-left" aria-hidden="true"></i></button> &nbsp;
                <button className="p-1 border border-0 ps-2 pe-2"><i class="fa fa-arrow-right" aria-hidden="true"></i></button>
            </div>
        </Row>
        </div>
